...
for aa in []:  # amino_acids:    
    all_analyzers["ACE_%s_NME" % aa] = [analyzers.BuzzScalarCouplingAnalyzer("ACE_%s_NME" % aa, "/home/kyleb/src/choderalab/ForcefieldData/nmr/bacteriophage_lysozyme/16664.str")]
    all_analyzers["ACE_%sG_NH2" % aa] = [analyzers.OhScalarCouplingAnalyzer("ACE_%sG_NH2" % aa, "/home/kyleb/src/choderalab/ForcefieldData/nmr/bacteriophage_lysozyme/16664.str")]
    all_analyzers["ACE_%G%s_NH2" % aa] = [analyzers.OhScalarCouplingAnalyzer("ACE_G%s_NH2" % aa, "/home/kyleb/src/choderalab/ForcefieldData/nmr/bacteriophage_lysozyme/16664.str")]
...
all_analyzers["1d3z"] = [analyzers.ChemicalShiftAnalyzer("1d3z", "/home/kyleb/src/choderalab/ForcefieldData/nmr/ubiquition/bmrb17439_v3.str")]
